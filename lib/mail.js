...
var engines={
	sendmail: require("./engines/sendmail"),
	SMTP: require("./engines/sendmail")
}
/*
...
fs.readdirSync(__dirname + '/engines').forEach(function(engine) {
	...
	console.log("engineName: ", (__dirname + '/engines/' + engine));
...
var X_MAILER_NAME = "Nodemailer",
    X_MAILER_VERSION = "0.2.2; +http://www.nodemailer.org";
